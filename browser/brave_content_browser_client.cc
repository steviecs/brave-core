...
// Based on GetOSVersion() in user_agent.cc. We can not override it (or even
// call the original function) because it is tucked inside an anonymous
// namespace. Changes are marked.
