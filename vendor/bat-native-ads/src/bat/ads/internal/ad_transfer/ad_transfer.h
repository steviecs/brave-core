...
#ifndef BAT_ADS_INTERNAL_AD_TRANSFER_AD_TRANSFER_H_  // NOLINT
#define BAT_ADS_INTERNAL_AD_TRANSFER_AD_TRANSFER_H_  // NOLINT
...
#endif  // BAT_ADS_INTERNAL_AD_TRANSFER_AD_TRANSFER_H_  NOLINT
