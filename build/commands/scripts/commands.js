...
function parseInteger(string) {
  // As per the spec [1], passing radix:0 to parseInt() will force parsing to
  // understand the string passed as a decimal number unless it'sprefixed with
  // '0' (octal) or '0x' (hexadecimal), so let's be explicit about that.
